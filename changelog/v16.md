...
- Animated overlay in top-right corner showing protagonist's inner monologue
- Dark semi-transparent terminal panel with cyan border, scan lines, and "// DP-7" header
- Typewriter effect with blinking cursor on latest thought
- Older thoughts dim, newest is bright — fades out after 8 seconds
- Max 4 visible thoughts, auto-scrolling
